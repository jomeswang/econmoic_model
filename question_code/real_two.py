...
def get_distribution(df, index):
    ...
    # return [statistics(opts['x'])[i] for i in range(3)]
    # print("收益率， 波动率，夏普率：", statistics(opts['x']))
    # print(opts['x'].round(3))
    # print(opts)
    # print("收益率， 波动率，夏普率：", statistics(optv['x']))
...
def on_data(context):
    ...
    # ['id', 'time', 'code', 'open', 'high', 'low', 'close', 'volume',
    #  'amount', 'open_interest']
    # print(data, len(data), data.keys())
    # data_by = data.groupby('code')
    # print(data_by['close'].mean())
    # print(context.target_list[0].lower())
    ...
    for i in range(0, 30):
        ...
        # print(first_target['time']=="2011/1/4")
        # print(last_index)
        if last_index == -1:
            continue
    ...
    # print(week_df)
    # print(week_profit_rate)
    # print(first_target.iloc[0]['code'])
    # profitAve = first_target['pro']
    # print(k,b,r,'\n',results.summary())
    # print(first_target['profitRate'])
